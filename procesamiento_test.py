...
class ProcesamientoTest(TestCase):
    ...
    def test_numeroDeElementosDosNumeros(self):
        self.assertEquals(Procesamiento().procesar("2,3"),[2,2,3,6],"2 números")
    def test_numeroDeElementosNNumeros(self):
        self.assertEquals(Procesamiento().procesar("2,3,4,5"),[4,2,5,6], "N números")
    ...
    def test_minimoNumeroDeElementosYMinimoDosElementos(self):
        self.assertEquals(Procesamiento().procesar("2,7"), [2,2,7,6], "Dos números")
    def test_minimoNumeroDeElementosYMinimoNElementos(self):
        self.assertEquals(Procesamiento().procesar("9,7,22,44"), [4,7,44,6], "N números")
    ...
    def test_NumeroDeElementosMinimoMaximoDosNumeros(self):
        self.assertEquals(Procesamiento().procesar("3,2"), [2,2,3,6], "N números")
    def test_NumeroDeElementosMinimoMaximoNNumeros(self):
        self.assertEquals(Procesamiento().procesar("3,2,8,6"), [4,2,8,6], "N números")
