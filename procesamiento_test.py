...
class ProcesamientoTest(TestCase):
    ...
    def test_numeroDeElementosUnNumero(self):
        self.assertEquals(Procesamiento().procesar("2"),[1,2,2,1],"Un número")
    ...
    def test_minimoNumeroDeElementosYMinimoUnElemento(self):
        self.assertEquals(Procesamiento().procesar("3"), [1,3,3,1], "Un Número")
    ...
    def test_NumeroDeElementosMinimoMaximoUnNumero(self):
        self.assertEquals(Procesamiento().procesar("3"), [1,3,3,1], "N números")
    ...
    def test_NumeroDeElementosMinimoMaximoNNumeros(self):
        self.assertEquals(Procesamiento().procesar("3,2,8,6"), [4,2,8,0], "N números")
